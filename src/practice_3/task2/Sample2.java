...
class Worker extends Employee{
    ...
    @Override
    public String toString() {
        return String.format("%s %s; Worker; Год рождения: %s; Средняя месячная зарплата: %.2f; Комментарий: %s",
...
class Freelancer extends Employee{
    ...
    @Override
    public String toString() {
        return String.format("%s %s; Freelancer; Год рождения: %s; Заработная плата за месяц: %.2f; Комментарий: %s",
                surName, firstName, birthYear, calculateSalary(), comment);
    }
